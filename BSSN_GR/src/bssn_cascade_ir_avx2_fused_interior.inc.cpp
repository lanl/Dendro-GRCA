// bssn_cascade_ir_avx2_fused_interior.inc.cpp -- 4-wide twin of
// bssn_cascade_ir_avx512_fused_interior.inc.cpp (same FUSED IR-generated
// body; AVX2 macros and 4-lane batches). Used for blocks whose interior
// x-extent is too narrow for an 8-batch, and as the kernel for the
// AVX2-only build (BSSN_USE_CASCADE_IR_AVX_FUSED). Interior-only
// (bflag == 0); caller runs the mixed-only deriv pre-pass.
{
#define VEC __m256d
