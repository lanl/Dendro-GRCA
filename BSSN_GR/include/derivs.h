...
extern void (*deriv_x)(double *const, const double *const, const double,
                       const unsigned int *, unsigned);
extern void (*deriv_y)(double *const, const double *const, const double,
                       const unsigned int *, unsigned);
extern void (*deriv_z)(double *const, const double *const, const double,
                       const unsigned int *, unsigned);

extern void (*deriv_xx)(double *const, const double *const, const double,
                        const unsigned int *, unsigned);
extern void (*deriv_yy)(double *const, const double *const, const double,
                        const unsigned int *, unsigned);
extern void (*deriv_zz)(double *const, const double *const, const double,
                        const unsigned int *, unsigned);

extern void (*ko_deriv_x)(double *const, const double *const, const double,
                          const unsigned int *, unsigned);
extern void (*ko_deriv_y)(double *const, const double *const, const double,
                          const unsigned int *, unsigned);
extern void (*ko_deriv_z)(double *const, const double *const, const double,
                          const unsigned int *, unsigned);
...
void deriv42_xx_pw2(double *const DxDxu, const double *const u, const double dx,
                    const unsigned int *sz, unsigned bflag);
void deriv42_yy_pw2(double *const Du, const double *const u, const double dy,
                    const unsigned int *sz, unsigned bflag);
void deriv42_zz_pw2(double *const Du, const double *const u, const double dz,
                    const unsigned int *sz, unsigned bflag);

void deriv42_xx_pw4(double *const DxDxu, const double *const u, const double dx,
                    const unsigned int *sz, unsigned bflag);
void deriv42_yy_pw4(double *const Du, const double *const u, const double dy,
                    const unsigned int *sz, unsigned bflag);
void deriv42_zz_pw4(double *const Du, const double *const u, const double dz,
                    const unsigned int *sz, unsigned bflag);
...
void deriv644_xx_pw4(double *const DxDxu, const double *const u,
                     const double dx, const unsigned int *sz, unsigned bflag);
void deriv644_yy_pw4(double *const Du, const double *const u, const double dy,
                     const unsigned int *sz, unsigned bflag);
void deriv644_zz_pw4(double *const Du, const double *const u, const double dz,
                     const unsigned int *sz, unsigned bflag);
...
// these are the derivs that will be used in the SOLVER CODE based on the FD
// derivative order.
// #ifdef BSSN_USE_4TH_ORDER_DERIVS
// #define deriv_x deriv42_x_wrapper
// #define deriv_y deriv42_y_wrapper
// #define deriv_z deriv42_z_wrapper
//
...
// #define deriv_x deriv644_x_wrapper
// #define deriv_y deriv644_y_wrapper
// #define deriv_z deriv644_z_wrapper
//
