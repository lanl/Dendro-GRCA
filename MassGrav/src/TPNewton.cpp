...
bicgstab ( int const nvar, int const n1, int const n2, int const n3,
          ...
          CCTK_REAL *  const normres);
static CCTK_REAL
norm_inf (CCTK_REAL const *  const F,
          int const ntotal);
static void
relax (CCTK_REAL *  const dv,
       int const nvar, int const n1, int const n2, int const n3,
       CCTK_REAL const *  const rhs,
       int const *  const ncols,
       int const *  const *  const cols,
       CCTK_REAL const *  const *  const JFD);
static void
resid (CCTK_REAL *  const res,
       int const ntotal,
       CCTK_REAL const *  const dv,
       CCTK_REAL const *  const rhs,
       int const *  const ncols,
       int const *  const *  const cols,
       CCTK_REAL const *  const *  const JFD);
static void
LineRelax_al (CCTK_REAL *  const dv,
	      ...
	      CCTK_REAL const *  const rhs,
              ...
              CCTK_REAL const *  const *  const JFD);
static void
LineRelax_be (CCTK_REAL *  const dv,
